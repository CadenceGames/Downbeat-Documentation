...
|Property | Dimention |  Description|
|:--- | :---: |  :---|
|`Strikers.Position` | 3D | Defines where the object containing all the strikers is placed in the world.|
|`Strikers.Rotation` | 3D | Defines the rotation of the object containing all the strikers, in euler angles.|
|`Strikers.Scale` | 3D | Defines the scale of the object containing all the strikers.|
|`Strikers.Lane1.LocalPosition` | 3D | Defines the local position (relative to `Strikers.Position`) of the striker in lane 1| 
|`Strikers.Lane1.LocalRotation` | 3D | Defines the local rotation (relative to `Strikers.Rotation`) of the striker in lane 1| 
|`Strikers.Lane1.LocalScale` | 3D | Defines the local scale (relative to `Strikers.Scale`) of the striker in lane 1| 
|`Strikers.Lane2.LocalPosition` | 3D | Defines the local position (relative to `Strikers.Position`) of the striker in lane 2| 
|`Strikers.Lane2.LocalRotation` | 3D | Defines the local rotation (relative to `Strikers.Rotation`) of the striker in lane 2| 
|`Strikers.Lane2.LocalScale` | 3D | Defines the local scale (relative to `Strikers.Scale`) of the striker in lane 2| 
|`Strikers.Lane3.LocalPosition` | 3D | Defines the local position (relative to `Strikers.Position`) of the striker in lane 3| 
|`Strikers.Lane3.LocalRotation` | 3D | Defines the local rotation (relative to `Strikers.Rotation`) of the striker in lane 3| 
|`Strikers.Lane3.LocalScale` | 3D | Defines the local scale (relative to `Strikers.Scale`) of the striker in lane 3| 
|`Strikers.Lane4.LocalPosition` | 3D | Defines the local position (relative to `Strikers.Position`) of the striker in lane 4| 
|`Strikers.Lane4.LocalRotation` | 3D | Defines the local rotation (relative to `Strikers.Rotation`) of the striker in lane 4| 
|`Strikers.Lane4.LocalScale` | 3D | Defines the local scale (relative to `Strikers.Scale`) of the striker in lane 4| 
|`Strikers.Lane5.LocalPosition` | 3D | Defines the local position (relative to `Strikers.Position`) of the striker in lane 5| 
|`Strikers.Lane5.LocalRotation` | 3D | Defines the local rotation (relative to `Strikers.Rotation`) of the striker in lane 5| 
|`Strikers.Lane5.LocalScale` | 3D | Defines the local scale (relative to `Strikers.Scale`) of the striker in lane 5| 
